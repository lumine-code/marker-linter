...
- **[marker.layer](https://lumine-code.github.io/docs.html#services/marker.layer)** (`1.0.0`): provided to register the `linter` marker layer drawn by the editor's overview maps.
